...
// listed is outermost. The recommended order puts resilience and fallback
// innermost, so retries and failover happen before metrics and cost are recorded
// once for the whole call, and observability and logging outermost. nil entries are
