...
**Risks:** this inverts the request direction (server to client), which the jsonrpc layer now
...
for images and audio, async create to poll to fetch jobs for video, and three output deliveries
