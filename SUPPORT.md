...
|---------|-------------|--------|
| **v5.x** | `github.com/nocturnium/llm-go-sdk/v6` | **Supported**, current; all fixes and new work land here |
...
guides. v4 to v5 is mostly a mechanical import-path bump to `/v5`, plus a handful of
