...
func TestMediaVideoConverters(t *testing.T) {
	for _, tc := range []struct{ resolution, aspect, size string }{
		{"", "", "1280x720"}, {"", "9:16", "720x1280"}, {"720p", "16:9", "1280x720"}, {"720p", "9:16", "720x1280"}, {"1024p", "16:9", "1792x1024"}, {"1024p", "9:16", "1024x1792"}, {"garbage", "1:1", ""}, {"720p", "1:1", ""}, {"720x1280", "", "720x1280"}, {"1280x720", "", "1280x720"}, {"1024x1792", "", "1024x1792"}, {"1792x1024", "", "1792x1024"},
	} {
