...
// Option is a function that configures a Groq client.
type Option func(*options)

// options contains configuration options for the Groq client.
type options struct {
	APIKey         string
	Model          string
...
// defaultOptions returns the default options for Groq.
