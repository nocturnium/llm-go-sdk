...
// Option is a function that configures a TogetherAI client
type Option func(*options)

// options contains configuration options for the TogetherAI client
type options struct {
	APIKey         string
	Model          string
...
// defaultOptions returns the default options for TogetherAI
