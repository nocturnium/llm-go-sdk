...
// the name (for example "gemini-flash-latest") are treated as older, so a caller
// running Gemini 3 through such an alias gets neither the call IDs Gemini 3
// pairs by nor the signature placeholder it needs for foreign history; pin a
// versioned model name instead.
