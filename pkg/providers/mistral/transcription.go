...
func (c *Client) transcribe(ctx context.Context, route string, audio llms.MediaInput, o *llms.TranscribeOptions) (*llms.Transcription, error) {
	...
	if wire.Usage.PromptAudioSeconds != nil && *wire.Usage.PromptAudioSeconds >= 0 {
		out.Usage = llms.MediaUsage{Unit: llms.MediaUnitMinute, Quantity: *wire.Usage.PromptAudioSeconds / 60}
	}
