...
// Option is a function that configures a Cerebras client.
type Option func(*options)

// options contains configuration options for the Cerebras client.
type options struct {
	APIKey         string
	Model          string
...
// defaultOptions returns the default options for Cerebras.
