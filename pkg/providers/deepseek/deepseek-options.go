...
// Option is a function that configures a DeepSeek client.
type Option func(*options)

// options contains configuration options for the DeepSeek client.
type options struct {
	APIKey         string
	Model          string
...
// defaultOptions returns the default options for DeepSeek.
