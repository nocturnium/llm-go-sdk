...
// Option is a function that configures a Fireworks client.
type Option func(*options)

// options contains configuration options for the Fireworks client.
type options struct {
	APIKey         string
	Model          string
...
// defaultOptions returns the default options for Fireworks.
