...
- **providers:** Account streamed speech usage and resolve deferred nitpick findings ([#64](https://github.com/nocturnium/llm-go-sdk/issues/64))

## [6.6.0] - 2026-09-06

### Features

- **media:** Add image, video, speech and transcription generation (Track D) ([#62](https://github.com/nocturnium/llm-go-sdk/issues/62))

## [6.5.1] - 2026-09-05

### Bug Fixes

- **anthropic:** Keep forced tool_choice under adaptive thinking; flag truncated streams ([#60](https://github.com/nocturnium/llm-go-sdk/issues/60))

## [6.5.0] - 2026-09-05

### Features

- **anthropic:** Align provider behavior with openaicompat and gemini paths ([#58](https://github.com/nocturnium/llm-go-sdk/issues/58))

## [6.4.0] - 2026-08-03

### Features

- **mcp:** Add roots and elicitation, completing Track C ([#56](https://github.com/nocturnium/llm-go-sdk/issues/56))

## [6.3.0] - 2026-08-03

### Features

- **mcp:** Serve sampling/createMessage from an llms.LLM, gated on consent ([#54](https://github.com/nocturnium/llm-go-sdk/issues/54))
